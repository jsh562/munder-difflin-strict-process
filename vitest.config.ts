...
export default defineConfig({
  ...
  // both the app's tests and the package's own tests import `@jsh562/won-agent-core`.
  resolve: {
    alias: { '@jsh562/won-agent-core': resolve(__dirname, 'packages/won-agent-core/src/index.ts') }
  },
  test: {
    environment: 'node',
